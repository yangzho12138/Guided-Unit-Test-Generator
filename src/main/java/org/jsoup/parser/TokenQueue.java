...
public class TokenQueue {
    ...
    public boolean matchesStartTag() {
        ...
        boolean flag = (remainingLength() >= 2);
        flag &= (queue.charAt(pos) == '<');
        flag &= (Character.isLetter(queue.charAt(pos+1)));
        return flag;
    }
     ...
     * @param seq String to end on (and not include in return,
     *            but leave on queue). <b>Case sensitive.</b>
    ...
    /**
     Consumes to the first sequence provided,
     or to the end of the queue. Leaves the terminator on the queue.
     ...
     * will return as much as it can (and queue will go
     * isEmpty() == true).
     * @param seq String to match up to, and not include in return,
     *            and to pull off queue. <b>Case sensitive.</b>
